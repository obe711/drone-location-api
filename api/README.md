# LocationAPI Node Server

After building the database, you can start the server from this directory or the parent directory by running:
...
```bash
git clone https://github.com/obe711/drone-location-api.git
```
...
# URL of the Mongo DB
MONGODB_URL=mongodb://mongo:27001,mongo:27002,mongo:27003/locationAPI
...
router.get("/api", validate(apiValidation.getApi), apiController.getApi);
```
